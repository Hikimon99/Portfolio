...
var doors3;
var haveSwordss;
var turret, bullets, enemy, bullet1, bullet2, bullet3;
var uplook = 0;
var look = 0;
...
export default class Level4 extends Phaser.Scene {
  ...
  create (data) {
    ...
    //Level number
    this.levelNumber = this.add.text(700, 20, 'Level 4', {
    fontSize: '20px',
    fill: '#000'
    });
    ...
    //Platforms Level 2
    platforms.create(1350, 750, 'ground').setScale(1,.5).refreshBody();
    platforms.create(650, 750, 'ground').setScale(1,.5).refreshBody();
    platforms.collideWorldBounds = true;

    //Platforms Level 3
    platforms.create(1700, 600, 'ground').setScale(1.3,.5).refreshBody();
    platforms.create(1000, 600, 'ground').setScale(1.3,.5).refreshBody();
    platforms.create(300, 600, 'ground').setScale(1.3,.5).refreshBody();
    platforms.collideWorldBounds = true;

    //Platforms Level 4
    platforms.create(1350, 450, 'ground').setScale(1,.5).refreshBody();
    platforms.create(1000, 450, 'ground').setScale(1,.5).refreshBody();
    platforms.create(650, 450, 'ground').setScale(1,.5).refreshBody();
    platforms.collideWorldBounds = true;
    ...
    doors.create(1700, 550, "reddoor-open").setScale(1).refreshBody();
    doors3.create(1000, 550, "door-open").setScale(1).refreshBody();
    if (this.haveKey){
      doors2.create(300, 550, "greendoor-open").setScale(1).refreshBody();
    }
    else{
      doors2.create(300, 550, "greendoor-closed").setScale(1).refreshBody();
    }
    ...
    this.turret1 = this.add.sprite(1350, 470, 'turret');
    this.turret1.setScale(3);
    this.turret1.setAngle(90);

    this.turret2 = this.add.sprite(1000, 880, 'turret');
    this.turret2.setScale(3);
    this.turret2.setAngle(270);

    this.turret3 = this.add.sprite(650, 470, 'turret');
